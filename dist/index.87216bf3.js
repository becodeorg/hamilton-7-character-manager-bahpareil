...
<<<<<<< HEAD
var _axiosJs = require("../../node_modules/axios/dist/axios.js");
var _axiosJsDefault = parcelHelpers.interopDefault(_axiosJs);
const wrapper = document.getElementById("card-wrapper");
getChara();
async function getChara() {
    try {
        const response = await (0, _axiosJsDefault.default).get("https://character-database.becode.xyz/characters");
...
<<<<<<< HEAD
},{"../../node_modules/axios/dist/axios.js":"3INuH","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"3INuH":[function(require,module,exports) {
...
>>>>>>> master
   ...
   */ var extend = function extend(a, b, thisArg) {
        var _ref2 = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : {}, allOwnKeys = _ref2.allOwnKeys;
   ...
   */ var matchAll = function matchAll(regExp, str) {
    ...
    /* Creating a function that will check if an object has a property. */ var hasOwnProperty = function(_ref3) {
   ...
   */ function AxiosError(message, code, config, request, response) {
    ...
    /* eslint-env browser */ var browser = (typeof self === "undefined" ? "undefined" : _typeof(self)) == "object" ? self.FormData : window.FormData;
    /**
    ...
    Object.assign(AxiosHeaders.prototype, {
        set: function set(header, valueOrRewrite, rewrite) {
            ...
            function setHeader(_value, _header, _rewrite) {
                ...
                var key = findKey(self1, lHeader);
                if (key && _rewrite !== true && (self1[key] === false || _rewrite === false)) return;
                self1[key || _header] = normalizeValue(_value);
            }
            if (utils.isPlainObject(header)) utils.forEach(header, function(_value, _header) {
    ...
    var adapters$1 = {
        getAdapter: function getAdapter(nameOrAdapter) {
            if (utils.isString(nameOrAdapter)) {
                ...
                if (!nameOrAdapter) throw Error(utils.hasOwnProp(nameOrAdapter) ? "Adapter '".concat(nameOrAdapter, "' is not available in the build") : "Can not resolve adapter '".concat(nameOrAdapter, "'"));
                return adapter;
            }
   ...
   */ function getDefaultAdapter() {
        ...
        else if (typeof process !== "undefined" && utils.kindOf(process) === "process") // For node use HTTP adapter
     ...
     */ _createClass(Axios, [
            {
                ...
                value: function request(configOrUrl, config) {
                    ...
                    var _config = config, transitional = _config.transitional, paramsSerializer = _config.paramsSerializer;
                    if (transitional !== undefined) validator.assertOptions(transitional, {
                        silentJSONParsing: validators.transitional(validators["boolean"]),
                        forcedJSONParsing: validators.transitional(validators["boolean"]),
                        clarifyTimeoutError: validators.transitional(validators["boolean"])
                    }, false);
                    if (paramsSerializer !== undefined) validator.assertOptions(paramsSerializer, {
...
},{"buffer":"fCgem","process":"d5jf4"}],"fCgem":[function(require,module,exports) {
=======
...
<<<<<<< HEAD
},{}]},["9MAGT","bqMLY"], "bqMLY", "parcelRequirea5f9")
=======
...
},{"./../utils.js":"5By4s","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["9MAGT","bqMLY"], "bqMLY", "parcelRequire621c")
>>>>>>> master
